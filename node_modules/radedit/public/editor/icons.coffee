...
icons =
	...
	search: [
		['555', '', 'M13,11h1.5l5,5l-1.5,1.5l-5,-5zM5.5,8.5c0,6,9,6,9,0c0-6-9-6-9,0z']
	]
	db: [
	...
	radedit: [
		['fc5', 'c60', 'M0.5,8c0,10,15,10,15,0c0-10-15-10-15,0z']
		['fc5', '900', 'M3.5,10c1,4,8,4,9,0c-1,1-8,1-9,0z']
		['bcf', '36c', 'M7,4.5c0-1,2-1,2,0c0,4,6,3,6,0l0.5-0.2l-0.5,0.2c0-1-6-1-6,0c0-1-2-1-2,0c0-1-6-1-6,0l-0.5-0.2l0.5,0.2c0,3,6,4,6,0z']
	]
	on: [
		['cfc', '090', 'M10.5,5c0,6,9,6,9,0c0-6-9-6-9,0z']
	]
	off: [
		['fcc', '900', 'M10.5,5c0,6,9,6,9,0c0-6-9-6-9,0z']
	]
	waiting: [
		['ffc', '990', 'M10.5,5c0,6,9,6,9,0c0-6-9-6-9,0z']
	]
	empty: []
