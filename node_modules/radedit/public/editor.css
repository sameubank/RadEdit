...
#console>pre.log { color:#ccc; }
#console>pre.trace { color:#0ff; }
#console>pre.debug {color:#f0f; }
#console>pre.info { color:#0f0; }
#console>pre.warn { color:#ff0; }
#console>pre.error { color:#f00; }
